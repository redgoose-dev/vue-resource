...
<article class="page">
	...
	<pre><code>@include text-single-line();</code></pre>
...
@include responsive('desktop-1920') {}</code></pre>
	...
	<section>
		...
		<p>배경 이미지 지원</p>
		<pre><code>@include image-background();</code></pre>
	</section>
	...
	<section>
		...
		<p>화면에서 안보이도록 합니다.</p>
		<pre><code>@include blind();</code></pre>
	</section>
	...
	<section>
		...
		<pre class="example-code"><code>ul {
	padding: 15px 0 0;
