...
@import "./etc";</code>
	...
	<p>각 리소스들은 Stylesheet 그룹의 각 페이지에서 자세히 다룬다.</p>

	<blockquote>
		<p>
			스타일시트의 리소스를 만든 의도는 그대로 쓰라고 만든것이 아니라 이 소스를 베이스로 만드려는 프로그램에 도움이 되라고 만든것이다.<br/>
			가장 중요한건 참고용이지 답안지가 절대 아니다.
		</p>
		<p>이것을 참고로 원하는 모습으로 제작에 더 빨리 접근 할 수 있도록 도움되길 바란다.</p>
	</blockquote>
</article>
</template>
